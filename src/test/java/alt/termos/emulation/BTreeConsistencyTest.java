...
public class BTreeConsistencyTest {
	...
	public void test() {
		...
		BTree<Integer, Integer, SimpleEntry<Integer, Integer>> testMap = BTree.newInstance(SimpleEntry.class, 3, Comparators.INTEGER);
	...
	private void testLoop(TreeMap<Integer, Integer> controlMap, BTree<Integer, Integer, SimpleEntry<Integer, Integer>> testMap) {
